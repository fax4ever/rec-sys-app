...
BASE_DATA_DIR = "https://raw.githubusercontent.com/RHEcosystemAppEng/rec-sys-app/refs/heads/main/feature_repo/data"
AMAZON_DATASET = BASE_DATA_DIR + "/amazon.csv"
AMAZON_DATASET_FIXED_IMAGE = BASE_DATA_DIR + "/amazon_with_fixed_images.csv"
...
def main():
    ...
    # dataset_provider = RemoteDatasetProvider(AMAZON_DATASET_FIXED_IMAGE)
